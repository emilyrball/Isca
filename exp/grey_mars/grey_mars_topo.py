    ...
    for conv in conv_schemes:
        for depth_val in depths:
            for per_value in pers:
                exp = Experiment('grey_mars_mk36_per_value'+str((per_value))+'_'+conv+'_mld_'+str(depth_val)+'_with_mola_topo', codebase=cb)
                exp.clear_rundir()
                ...
                exp.inputfiles = [os.path.join(base_dir,'input/t42_mola_mars.nc')]
