...
inputfiles = [os.path.join(base_dir,'input/sp_lw_17_dsa_mars'), os.path.join(base_dir,'input/sp_sw_42_dsa_mars_sun'), os.path.join(base_dir,'input/sp_lw_17_dsa_mars_k'), os.path.join(base_dir,'input/sp_sw_42_dsa_mars_sun_k'), os.path.join(base_dir,'input/t85_mola_mars.nc')]
...
#     },
    ...
    'spectral_init_cond_nml': {
        'topog_file_name': 't85_mola_mars.nc',
    ...
    for conv in conv_schemes:
        for depth_val in depths:
            for per_value in pers:
                exp = Experiment('soc_mars_mk36_T85_per_value'+str((per_value))+'_'+conv+'_mld_'+str(depth_val)+'_with_mola_topo', codebase=cb)
                exp.clear_rundir()
